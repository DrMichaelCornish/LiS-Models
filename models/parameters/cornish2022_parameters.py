...
class Cornish2022Parameters:
    ...
    def __init__(self):
        ...
        # BV parameters
        self.alphaH_cath = pybamm.Parameter('High Plateau Symmetry Factor')
        self.alphaM_cath = pybamm.Parameter('Middle Plateau Symmetry Factor')
        self.alphaL_cath = pybamm.Parameter('Low Plateau Symmetry Factor')
        self.S8_stoch_H = pybamm.Parameter('High Plateau S8 Stoch Coeff')
        self.S4_stoch_H = pybamm.Parameter('High Plateau S4 Stoch Coeff')
        self.S4_stoch_M = pybamm.Parameter('Middle Plateau S4 Stoch Coeff')
        self.S2_stoch_M = pybamm.Parameter('Middle Plateau S2 Stoch Coeff')
        self.S2_stoch_L = pybamm.Parameter('Low Plateau S2 Stoch Coeff')
        self.S1_stoch_L = pybamm.Parameter('Low Plateau S1 Stoch Coeff')
        self.S8_ref_cath = pybamm.Parameter('S8 Reference Cathodic')
        self.S4_ref_cath = pybamm.Parameter('S4 Reference Cathodic')
        self.S2_ref_cath = pybamm.Parameter('S2 Reference Cathodic')
        self.S1_ref_cath = pybamm.Parameter('S1 Reference Cathodic')
        self.S8_ref_anod = pybamm.Parameter('S8 Reference Anodic')
        self.S4_ref_anod = pybamm.Parameter('S4 Reference Anodic')
        self.S2_ref_anod = pybamm.Parameter('S2 Reference Anodic')
        self.S1_ref_anod = pybamm.Parameter('S1 Reference Anodic')